...
export declare const LASTDB_UDS_SHARED_ROUTES: readonly [readonly ["POST", "/api/query"], readonly ["POST", "/api/mutation"], readonly ["POST", "/api/app/search"], readonly ["POST", "/api/app/changes"], readonly ["GET", "/api/schemas"], readonly ["GET", "/api/system/auto-identity"]];
