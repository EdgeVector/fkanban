...
kanban pickup claim-v2 --dry-run --json
```
...
`fkanban_move`, `fkanban_rank`, `fkanban_pickup_claim`, `fkanban_pickup_claim_v2`, `fkanban_overlap`, `fkanban_dep_add`, `fkanban_dep_rm`, `fkanban_tag_add`,
